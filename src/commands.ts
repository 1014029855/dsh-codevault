...
import { entryKindText, subjectLabel, subjectTitle } from './domain.js'

export const READ_COMMAND_NAME = 'codevault'

function usageText(): CommandResult {
...
function recentText(): CommandResult {
  const stats = archiveStats()
...
export function codevaultCommandHandler(rawInput: string): CommandResult {
